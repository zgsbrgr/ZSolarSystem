...
val Saturn = Planet(
    ...
    moons = listOf("Mimas","Enceladus","Tethys", "..."),
    gravity = "10.44 m/s²",
    tiltOfAxis = "26.73°",
...
val Neptune = Planet(
    ...
    moons = listOf("Naiad","Thalassa","Despina", "..."),
    gravity = "11.15 m/s²",
    tiltOfAxis = "28°",
...
val Uranus = Planet(
    ...
    moons = listOf("Puck","Miranda","Ariel", "..."),
    gravity = "8.87 m/s²",
    tiltOfAxis = "23°",
